...
class Hospital:
    ...
    def iPrescriptionDate(self):
        ...
        my_cursor.execute(f"insert into hospital values({self.Nameoftablets.get()},{self.ref.get()},{ self.Dose.get()},{ self.Dose.get()},{self.Numberoftablets.get()},{self.Lot.get()},{self.Issuedate.get()},{self.ExpDate.get()},{self.DailyDose.get()},{self.StorageAdvice.get()},{self.nhsNumber.get()},{self.PatientName.get()},{self.DateOfBirth.get()},{self.PatientAddress.get()})" 
